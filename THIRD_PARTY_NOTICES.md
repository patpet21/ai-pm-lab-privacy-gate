...
AI PM LAB Privacy Gate is distributed under the MIT License. Its Windows package includes or depends on open-source components. The list below covers the primary runtime and build components used by version 0.3.1; their own license texts and notices remain authoritative.

| Component | Version used for 0.3.1 | License | Project |
|---|---:|---|---|
