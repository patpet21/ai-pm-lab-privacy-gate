...
class GmailImportDialog(QDialog):
    def __init__(self, main_window):
        ...
        instructions.addWidget(_text('PrivacyGate is ready to receive from Gmail', True))
        instructions.addWidget(_text('1. Keep PrivacyGate desktop running.'))
        instructions.addWidget(_text('2. In Gmail, open an email and the PrivacyGate sidebar.'))
        instructions.addWidget(_text('3. Click Send to PrivacyGate. The selected email will appear automatically.'))
        actions = QHBoxLayout()
