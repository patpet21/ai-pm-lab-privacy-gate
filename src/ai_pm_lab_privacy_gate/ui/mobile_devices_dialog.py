...
class AdvancedPairingDataDialog(QDialog):
    def __init__(self, payload: str, parent=None) -> None:
        ...
        self.setStyleSheet(
            ...
            QLabel#title { color: #111827; font-size: 18px; font-weight: 700; }
            ...
            QPushButton {
                min-height: 38px; border-radius: 9px; padding: 0 14px; font-weight: 600;
...
class MobileDevicesDialog(QDialog):
    ...
    def _stylesheet() -> str:
        ...
        QFrame#softCard { background: #f8fafc; border: 1px solid #e4e9ef; border-radius: 12px; }
        ...
        QLabel#sectionTitle { font-size: 16px; font-weight: 700; color: #152238; }
        QLabel#stepNumber {
            min-width: 26px; max-width: 26px; min-height: 26px; max-height: 26px;
            border-radius: 13px; background: #e8f7f6; color: #087e84; font-weight: 700;
        }
        QLabel#selectionTitle { font-weight: 700; color: #123f46; }
        ...
        QListWidget::item { color: #1d2939; padding: 9px 10px; margin: 2px; border-radius: 8px; }
    ...
    def _build_pending_card(self) -> QFrame:
        ...
        helper = QLabel("Confirm the device details before approving a new pairing request.")
    ...
    def _render_qr(self, payload: str) -> None:
        try:
            ...
            code = qrcode.QRCode(version=None, error_correction=ERROR_CORRECT_L, box_size=1, border=4)
            ...
            self.qr.clear()
            self.qr.setText("QR generation is unavailable. Use Advanced pairing data for the JSON fallback.")
    ...
    def _approve(self) -> None:
        ...
        answer = QMessageBox.question(
            ...
            "Library access remains explicit and item-by-item.",
        )
