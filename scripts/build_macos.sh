...
case "$ARCH" in
  arm64)
    ...
    CLOUDFLARED_SHA256="f35c50089cd25f77a4cb5a2152036bc26db15aa31fbe11f7995d2e42a4ed6257" ;;
  x86_64)
    RELEASE_ARCH="amd64"; DISPLAY_ARCH="Intel"
    CLOUDFLARED_SHA256="e88fe5874d42a94f49a7ea59cabc3722d2962d0449232b0f3b1a426a712e275c" ;;
...
DMG="release/macos-$RELEASE_ARCH/AI_PM_LAB_Privacy_Gate_0.4.0_${DISPLAY_ARCH}.dmg"
